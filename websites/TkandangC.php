                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Tambah Data Kandang C</h5>
                            </div>
                            <ul class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Tambah Data Kandang C</h1>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  placeholder="Total pakan (kg).." name="pakan_total" required="" autocomplete="off">
                        ...
                        <div class="col">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  placeholder="Berat telur (kg)" name="berat_telur" required="" autocomplete="off" min="0">
                            </div>

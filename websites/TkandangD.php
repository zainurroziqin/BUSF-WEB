                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Tambah Data Kandang D</h5>
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="Dashboard.php"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="KandangD.php">Kandang D</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Tambah Data Kandang D</h1>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control"  placeholder="Berat telur (kg)" name="berat_telur" required="" autocomplete="off" min="0">
                            </div>

                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#!">Kandang C</a></li>
                    ...
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            ...
                            <?php foreach ($kandang_c as $row ): ?>
                                ...
                                <td>
                                    <a href="EkandangC.php?id=<?=$row["id"]; ?> " type="button" class="btn btn-primary btn-sm">
                                    <i class="fas fa-eye"></i>
                                     Detail</a>  
                                    <a href="HapuskandangC.php?id=<?=$row["id"]; ?>"  type="button" class="btn btn-danger btn-sm tombol-hapus"onclick="return confirm('yakin?');">

                        ...
                        <div class="dt-responsive table-responsive">
                            ...
                            <?php foreach ($kandang_d as $row ): ?>
                               ...
                               <td><?= date ('d F Y', strtotime ($row["tanggal"])); ?></td>
                                ...
                                <td>
                                    <a href="EkandangD.php?id=<?=$row["id"]; ?> " type="button" class="btn btn-primary btn-sm">
                                    <i class="fas fa-eye"></i>
                                     Detail</a>  
                                    <a href="HapuskandangD.php?id=<?=$row["id"]; ?>"  type="button" class="btn btn-danger btn-sm tombol-hapus"onclick="return confirm('yakin?');">

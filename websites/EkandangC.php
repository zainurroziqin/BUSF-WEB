...
$kda = query("SELECT * FROM kandang_c WHERE id = $id")[0];
    ...
    echo "
        <script>
            ...
            window.setTimeout(function(){ 
                window.location.replace('KandangC');
            },1800);
        </script>
    ";
} else {
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="KandangA.php">Kandang C</a></li>
                                  <li class="breadcrumb-item"><a href="">Detail Kandang C</a></li>
